...
## Purpose
Define the semantic color, type, spacing, radius, and motion tokens
consumed by every Flutter screen, plus the light and dark themes derived
from a single M3 seed.
