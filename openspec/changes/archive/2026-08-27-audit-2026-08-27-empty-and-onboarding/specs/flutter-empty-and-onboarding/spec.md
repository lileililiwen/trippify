# Flutter Empty States and Onboarding Specification

## Purpose
Standardize first-time-user onboarding, post-action confirmation, and
typed error feedback so the user always knows what happened and what
to do next.
