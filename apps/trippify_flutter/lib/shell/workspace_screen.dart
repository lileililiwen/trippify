  ...
  sections.add(
    WorkspaceSection(
      ...
      entries: [
        ...
        WorkspaceEntry(
          label: l10n.entryFindCreator,
          icon: Icons.person_search_outlined,
          route: '/creator',
          description: l10n.entryFindCreatorDesc,
        ),
        WorkspaceEntry(
    ...
    sections.add(
      WorkspaceSection(
        ...
        entries: [
          ...
          WorkspaceEntry(
            label: l10n.entryPluginCatalog,
            icon: Icons.extension_outlined,
            route: '/plugins',
            description: l10n.entryPluginCatalogDesc,
          ),
          WorkspaceEntry(
            label: l10n.entrySelfHostedStatus,
            icon: Icons.dns_outlined,
            route: '/system',
            description: l10n.entrySelfHostedStatusDesc,
          ),
        ],
      ),
    );
